import {
    ...
    UPDATE_PRODUCT_DETAILS_RESET,
    CLEAR_ERRORS
}
    from '../constants/productConstants'

//Product reducer get products
...
// product reducder get product details
...
// product reducer get product reviews
...
export const adminUpdateProduct = (state = {}, action) => {
    ...
    switch (action.type) {
        ...
        case UPDATE_PRODUCT_DETAILS_FAIL:
            return {
                ...state,
                loading: false,
                error: action.payload
        ...
        case UPDATE_PRODUCT_DETAILS_RESET:
            return {
                ...state,
                isUpdated: false
            };
